    ...
    <div class="dashboard-main-wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="users.php"><i class="fas fa-user-plus fa-lg"></i> Users</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    <div class="row m-2">
                        <h2 class="m-2"><i class="fas fa-user-plus"></i> Users</h2>
                        <?php if((int)$_SESSION['role_id'] === 1){  ?>
                        <button type="button" data-toggle="modal" data-target="#addUsers" class="btn btn-success m-1">
                                ...
                                if(!empty($users)){
                                    foreach ($users as $user) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <?php if((int)$_SESSION['role_id'] === 1){  ?>
                                                <button type="button" data-toggle="modal" data-target="#editUser<?php echo $user['id']; ?>" class="btn btn-primary">
                                                    <i class="fas fa-pen"></i> Edit
                                                </button>
                                                <!-- Edit warehouse modal -->
                                                <div class="modal fade" id="editUser<?php echo $user['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editUser<?php echo $user['id']; ?>" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h1 class="modal-title" id="editUser<?php echo $user['id']; ?>">Edit User</h1>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <form action="../Service/editUser.php" method="post">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="mb-2">
                                                                        ...
                                                                        <input type="text" class="form-control" required placeholder="Enter user name" name="user_name" value="<?php echo $user['user_name']; ?>">
                                                                    </div>
                                                                    <div class="mb-2">
                                                                        <label>Password</label>
                                                                        <input type="password" class="form-control" required placeholder="Enter password" name="password" value="<?php echo $user['password']; ?>">
                                                                    </div>
                                                                </div>
                                                ...
                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteUser<?php echo $user['id']; ?>">
                                                    <i class="fas fa-trash"></i> Delete
                                                </button>
                                                <!-- Delete modal -->
                                                <div class="modal fade" id="deleteUser<?php echo $user['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="deleteUser<?php echo $user['id']; ?>" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h1 class="modal-title" id="deleteUser<?php echo $user['id']; ?>">Delete User</h1>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="../Service/deleteUser.php?id=<?php echo $user['id']; ?>">
        ...
        <div class="modal fade" id="addUsers" tabindex="-1" role="dialog" aria-labelledby="addUsers" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title" id="addUsers">Add Users</h1>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="../Service/addUser.php" method="post">
                        <div class="modal-body">
                            ...
                            <div class="mb-2">
                                <label>User name</label>
                                <input type="text" class="form-control" required placeholder="Enter user name" name="user_name">
                            </div>
                            <div class="mb-2">
                                <label>Password</label>
